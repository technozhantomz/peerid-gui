...
class CustomInput extends Component {
  constructor(props) {
    ...
    const handleClick = this.props.handleClick || dummyHandler;
  ...
  render() {
    ...
    const height = this.props.multiline ? 'fit-content' : '.5rem';
    ...
    if (this.props.isValid && this.props.singleLength) {
    ...
    } else if(this.props.isValid && !this.props.singleLength){
