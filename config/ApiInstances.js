...
/**
    Configure: configure as follows `Apis.instance("wss://wss.homepesa.org").init_promise`.  This
...
exports.default = {
  ...
  reset: function reset() {
    var cs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'wss://wss.homepesa.org';
